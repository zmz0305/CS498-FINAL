	...
	addRepo : function(){
		...
		var dom = (
			React.createElement("div", {className: "modal-content"}, 
				...
				React.createElement("div", {className: "row ctr"}, 
					React.createElement("p", null, "Sign in with Google!!"), 
					React.createElement("a", {className: "waves-effect waves-light btn red expand"}, "Sign in with Google+ ", React.createElement("i", {className: "fa fa-google-plus"})), 
					React.createElement("p", null, "Or you can get an account from google to use"), 
					React.createElement("a", {className: "waves-effect waves-light btn blue expand"}, "Get an account from google! ", React.createElement("i", {className: "fa fa-google"}))
				)
				)
			)
		)
		window.actions.changeModal({dom: dom, visible: true});
	},
	render : function(){
